...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("documentos_DB", "documentos_db"),
        'USER': os.environ.get("documentos_DB_USER", "documentos_user"),
        'PASSWORD': os.environ.get("documentos_DB_PASSWD", "isis2503"),
        'HOST': os.environ.get("documentos_DB_HOST", "10.128.0.83"),
        'PORT': os.environ.get("documentos_DB_PORT", "5432")
    }
}
...
PATH_VAR = "http://" + os.environ.get("TIPOS_HOST", "10.128.0.84") + ":" + os.environ.get("TIPOS_PORT", "8080") + "/tipos"
...
SOCIAL_AUTH_AUTH0_DOMAIN = 'dev-y3pgtndrb2bzg280.us.auth0.com'
